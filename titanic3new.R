...
titanic3 <- read_excel("C:/Users/Frank/Downloads/titanic3.xls")
View(titanic3)
...
titanic3$age[is.na(titanic3$age)] <- median(titanic3$age, na.rm = TRUE)
...
write.csv(titanic3, "C:/Users/Frank/Downloads/titanic_clean.csv")
